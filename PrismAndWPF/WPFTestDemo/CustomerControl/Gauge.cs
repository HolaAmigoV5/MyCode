...
namespace WPFTestDemo
{
    public class Gauge : UserControl
    {
        ...
        public Gauge()
        {
            ...
            PercentTextBlock = new TextBlock();
            ...
            Canvas.Children.Add(PercentTextBlock);
            ...
            Panel.SetZIndex(PercentTextBlock, 1);
        ...
        private TextBlock PercentTextBlock { get; set; }
        ...
        /// <summary>
        /// show the title below the circle.
        /// </summary>
        public string Title
        {
        ...
        public static readonly DependencyProperty TitleProperty =
            DependencyProperty.Register("Title", typeof(string), typeof(Gauge), new PropertyMetadata(default(string)));

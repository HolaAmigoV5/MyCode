...
{
    /// <summary>
    /// 描述：Base_UserBusiness
    /// 作者：wby 2019/11/20 8:58:35
    /// </summary>
    public class Base_UserBusiness : BaseBusiness<Base_User>, IBase_UserBusiness, IDependency
    {
        #region 成员构造
        private IBase_UserDTOCache _sysUserCache { get; }
        private IOperator _operator { get; }
        private IPermissionManage _permissionManage { get; }
        IDataPermission _dataPermission { get; }

        public Base_UserBusiness(IBase_UserDTOCache sysUserCache, IOperator @operator,
            IPermissionManage permissionManage, IDataPermission dataPermission)
        {
        ...
        {
            Expression<Func<Base_User, Base_Department, Base_UserDTO>> select = (a, b) => new Base_UserDTO { DepartmentName = b.Name };

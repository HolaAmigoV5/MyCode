...
namespace My.Util
{
    ...
    public static partial class Extention
    {
        ...
        public static string EntityToJson(this object obj)
        {
            ...
            {
                jsonStr += $"\"{infos[i].Name}\":\"{infos[i].GetValue(obj).ToString()}\"";
                //jsonStr = jsonStr + "\"" + infos[i].Name + "\":\"" + infos[i].GetValue(obj).ToString() + "\"";
                if (i != infos.Length - 1)
                    jsonStr += ",";
            }
            jsonStr += "}";
        ...
        public static string ToXmlStr<T>(this T obj, string rootNodeName)
        {
            ...
            var jsonStr = obj.ToJson();
            var xmlStr = JsonConvert.DeserializeXmlNode(jsonStr, rootNodeName);
            return xmlStr.InnerXml;
        }
        ...
        /// <param name="fieldName">字段名</param>
        /// <returns></returns>
        public static object GetFiledValue(this object obj, string fieldName)
        {

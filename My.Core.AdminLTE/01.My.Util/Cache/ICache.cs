...
namespace My.Util
{
    ...
    public interface ICache
    {
        ...
        /// <param name="timeout">从现在起时间间隔</param>
        void SetKeyExpire(string key, TimeSpan expiry);
        #endregion
        ...
        /// </summary>
        /// <param name="key">主键</param>
        /// <param name="expiry">锁定失效时间</param>
        /// <param name="retryInterval">重试间隔</param>
        /// <param name="retryCount">重试次数</param>
        /// <param name="action">业务操作</param>
        /// <returns>lockSuccess:是否成功获取锁,actionSuccess:业务执行是否成功,ex:失败异常</returns>
        (bool lockSuccess, bool actionSuccess, Exception ex) UseLock(string key, TimeSpan expiry,
            TimeSpan retryInterval, int retryCount, Action action);
        ...
        /// <returns>lockSuccess:是否成功获取锁,actionSuccess:业务执行是否成功,ex:失败异常</returns>
        (bool lockSuccess, bool actionSuccess, Exception ex) UseLock(string key, TimeSpan expiry,
            TimeSpan retryInterval, TimeSpan retryTime, Action action); 
        #endregion
    }

...
namespace My.Util
{
    ...
    public class BaiduApiHelper
    {
        ...
        #region 私有成员方法
        private string _accessKeyId, _secretAccessKey;
        ...
        public string RequestData(string method, string host, string url, Dictionary<string, object> paramters = null)
        {
            ...
            string signDate = now.ToUniversalTime().ToString("yyyy'-'MM'-'dd'T'HH':'mm':'ss");
        ...
        public static bool SendMsg(string phoneNum, string code)
        {
            try
            {
                ...
                paramters.Add("contentVar", new { others = "你好", code });

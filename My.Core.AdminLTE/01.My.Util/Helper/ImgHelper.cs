...
namespace My.Util
{
    ...
    public class ImgHelper
    {
        ...
        {
            return CompressImg(img, (int)(((double)width) / img.Width * img.Height));
        }
        ...
        {
            string base64Url = "data:image/jpg;base64," + ToBase64String(img);
            return base64Url;
        }

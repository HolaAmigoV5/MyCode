...
namespace My.Util
{
    ...
    public class TreeHelper
    {
        ...
        /// <returns></returns>
        public static List<T> GetAllChildren<T>(List<T> allNodes, T parentNode) where T : TreeModel
        {
            ...
            {
                var children = _allNodes.Where(x => x.ParentId == parentNode.Id).ToList();

...
namespace My.Util
{
    ...
    public class FileHelper
    {
        ...
        public static void WriteTxt(string content,string path, FileMode fileMode)
        {
            WriteTxt(content, path, Encoding.UTF8, fileMode);
        }
        ...
        /// <param name="encoding">编码</param>
        /// <param name="fileMode">写入模式</param>
        public static void WriteTxt(string content, string path, Encoding encoding, FileMode fileMode)
        {
            WriteTxt(content, path, encoding, (FileMode?)fileMode);
        }
        ...
        public static void WriteTxt(string content, string path, Encoding encoding, FileMode? fileMode)
        {
            ...
            using (FileStream fileStream = new FileStream(path, fileMode.Value))
            {

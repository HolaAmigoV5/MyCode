...
{
    /// <summary>
    /// 描述：Session帮助类,自定义Session,解决原Session并发问题
    /// 作者：wby 2019/10/12 16:30:25
    /// </summary>
    public class SessionHelper
    {
        ...
        /// 存放Session标志的Cookie名
        /// </summary>
        public static string SessionCookieName { get; } = "My.Framework.ASP.NETCore_Session_Id";

        /// <summary>
        /// 当前Session
        /// </summary>
        public static Session CurrentSession { get; } = new Session();

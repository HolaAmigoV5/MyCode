...
namespace My.Util
{
    /// <summary>
    /// 描述：MySql数据库操作帮助类
    /// 作者：wby 2019/9/25 13:21:45
    /// </summary>
    public class MySqlHelper : DbHelper
    {
        #region 构造函数
        public MySqlHelper(string nameOfConStr) : base(DatabaseType.MySql, nameOfConStr) { }
        #endregion
        ...
        {
            string sql = @"select DISTINCT a.COLUMN_NAME as Name,a.DATA_TYPE as Type,
	                    (a.COLUMN_KEY = 'PRI') as IsKey, (a.IS_NULLABLE = 'YES') as IsNullable,

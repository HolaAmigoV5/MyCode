...
namespace My.Repository
{
    ...
    public class ShardingConfig
    {
        ...
        private SynchronizedCollection<AbstractDatabase> _absDb { get; } = new SynchronizedCollection<AbstractDatabase>();
        ...
        {
            _absDb.Add(new AbstractDatabase
            {
                AbsDbName = absDbName,
                Tables = tables
            });
        ...
        /// <param name="absDbName">抽象数据库名</param>
        /// <returns></returns>
        public (string tableName, string conString, DatabaseType dbType) GetWriteTables(string absTableName, object obj, string absDbName = null)
        {
        ...
        {
            return GetTargetTables(absTableName, ReadWriteType.Write, absDbName);
        } 
        #endregion
    }

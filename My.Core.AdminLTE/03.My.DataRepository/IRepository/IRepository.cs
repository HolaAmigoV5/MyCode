...
namespace My.Repository
{
    ...
    public interface IRepository : IBaseRepository
    {
        ...
        int Delete_Sql<T>(Expression<Func<T, bool>> whereExpre) where T : class, new();
        #endregion
        ...
        /// <returns>影响条数</returns>
        int UpdateWhere_Sql<T>(Expression<Func<T, bool>> whereExpr, params (string field, object value)[] values) where T : class, new();
        #endregion

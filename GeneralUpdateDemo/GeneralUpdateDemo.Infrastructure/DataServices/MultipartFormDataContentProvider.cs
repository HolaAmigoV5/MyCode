...
namespace GeneralUpdateDemo.Infrastructure.DataServices
{
    public class MultipartFormDataContentProvider
    {
        ...
        private static ByteArrayContent CreateByteArrayContent(string key, string fileName, string fileContent, byte[] fileBytes)
        {

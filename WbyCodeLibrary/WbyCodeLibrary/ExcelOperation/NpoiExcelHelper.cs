...
namespace WbyCodeLibrary.ExcelOperation
{
    ...
    {
        private static NpoiExcelHelper _excelHelper;
        public static NpoiExcelHelper ExcelHelper
        {
            get => _excelHelper ?? (_excelHelper = new NpoiExcelHelper());
        ...
        /// <returns></returns>
        public HSSFCellStyle CreateStyle(HSSFWorkbook workbook, HorizontalAlignment hAlignment, VerticalAlignment vAlignment,
            short fontHeightInPoints, bool isAddBorder, bool isBold, string fontName = "宋体", bool isAddBorderColor = true,
            ...
            FontUnderlineType underlineStyle = FontUnderlineType.None, FontSuperScript typeOffset = FontSuperScript.None, bool isStrikeout = false)
        {
            ...
            //背景颜色，边框颜色，字体颜色都是使用 HSSFColor属性中的对应调色板索引，关于 HSSFColor 颜色索引对照表，
            //详情参考：https://www.cnblogs.com/Brainpan/p/5804167.html
             ...
             * 设置相关字体样式
             */
            HSSFFont cellStyleFont = (HSSFFont)workbook.CreateFont(); //创建字体
